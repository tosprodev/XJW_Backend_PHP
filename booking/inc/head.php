...
<head>
    ...
    <title><?php echo $pname;?> - XJW Mobile Massage</title>
    ...
    <link rel="stylesheet" type="text/css" href="app-assets/css/pages/modal-create-app.min.css">
    <!-- END: Page CSS-->
	...
	<!-- Sweetalert 2 CSS -->
	<link rel="stylesheet" href="app-assets/js/plugins/sweetalert2/sweetalert2.min.css">
