<!-- BEGIN: Head-->
<?php 
$pname = "Booking with health fund";
	...
	?>
				...
				<div class="row" id="table-bordered">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Completed Bookings with health fund</h4>
                            </div>
							<div class="card-body">
                                <a href="bookings_history_cm_hf.php">
					...
					$uid = $_SESSION['id'];
	        $stmta = $conn->prepare("SELECT id, service, fullname, dob, email, address, health_provider, health_provider_no, practitioner_gender, practitioner, BDate, duration, time_slot, add_req, scharge, tfee, total, status, payment_status, transaction_id, invoice_id, uid, cur_time FROM health_fund_booking WHERE uid=$uid && status='2' OR status='4' ORDER BY id DESC LIMIT 5");
	...
	?>
				...
				<div class="row" id="table-bordered">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Cancelled Bookings with health fund <h4>
                            </div>
							<div class="card-body">
                                <a href="cancelled_bookings_hf.php">
	        ...
	        $uid = $_SESSION['id'];
	        $stmta = $conn->prepare("SELECT id, service, fullname, dob, email, address, health_provider, health_provider_no, practitioner_gender, practitioner, BDate, duration, time_slot, add_req, scharge, tfee, total, status, payment_status, transaction_id, invoice_id, uid, cur_time FROM health_fund_booking WHERE uid=$uid && status='3' ORDER BY id DESC LIMIT 5");
