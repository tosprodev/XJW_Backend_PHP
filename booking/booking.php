	...
	?>
				...
				<div class="row" id="table-bordered">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Completed Bookings</h4>
                            </div>
							<div class="card-body">
                                <a href="bookings_history_cm.php">
								<button type="button" class="btn btn-relief-success">View All</button>
								</a>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered">
					...
					$uid = $_SESSION['id'];
	        $stmta = $conn->prepare("SELECT id, service, practitioner, bdate, duration, timeslot, booking_for, recipient, address, note, scharge, tfee, total, status, payment_status, transaction_id, invoice_id, uid, cur_time FROM booking WHERE uid=$uid && status='2' OR status='2' ORDER BY id DESC LIMIT 10");
			...
			if ($booking_for == "Myself"){
				$client_name = $_SESSION['first_name']." ".$_SESSION['last_name'];
			} else if($booking_for == "Recipient"){
					$client_name = $recipient;
			} else {
				$client_name = "Deleted Recipient";
			}
	...
	?>
				...
				<div class="row" id="table-bordered">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Recent Cancelled Bookings</h4>
                            </div>
							<div class="card-body">
                                <a href="cancelled_bookings.php">
								<button type="button" class="btn btn-relief-danger">View All</button>
								</a>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-bordered">
					...
					$uid = $_SESSION['id'];
	        $stmt = $conn->prepare("SELECT id, service, practitioner, bdate, duration, timeslot, booking_for, recipient, address, note, scharge, tfee, total, status, payment_status, transaction_id, invoice_id, uid, cur_time FROM booking WHERE uid=$uid && status='3' ORDER BY id DESC LIMIT 5");
